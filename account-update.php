 ...
 <div class='lgs-container'>
	<form action="save-account.php?ut=<?php echo $type; ?>&ret=lgs" method="post" id="update-account">
		...
		<div class="left">
			...
			<p><input class="inputText" id="Gradelevel" name="level" type="number" maxlength="2" placeholder="Enter your grade level..." value="<?php echo $user->getGrade_level(); ?>" required/></p>
		</div>		
		<?php } ?>
		<div class="clear"></div>
